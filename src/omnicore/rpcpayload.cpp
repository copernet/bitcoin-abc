...
{ //  category                         name                                      actor (function)                         okSafeMode
  //  -------------------------------- ----------------------------------------- ---------------------------------------- ----------
    { "omni layer (payload creation)", "whc_createpayload_simplesend",          &whc_createpayload_simplesend, {} },
    { "omni layer (payload creation)", "whc_createpayload_sendall",             &whc_createpayload_sendall, {} },
    { "omni layer (payload creation)", "whc_createpayload_sto",                 &whc_createpayload_sto, {} },
    { "omni layer (payload creation)", "whc_createpayload_grant",               &whc_createpayload_grant, {} },
    { "omni layer (payload creation)", "whc_createpayload_revoke",              &whc_createpayload_revoke, {} },
    { "omni layer (payload creation)", "whc_createpayload_changeissuer",        &whc_createpayload_changeissuer, {} },
    { "omni layer (payload creation)", "whc_createpayload_issuancefixed",       &whc_createpayload_issuancefixed, {} },
    { "omni layer (payload creation)", "whc_createpayload_issuancecrowdsale",   &whc_createpayload_issuancecrowdsale, {} },
    { "omni layer (payload creation)", "whc_createpayload_issuancemanaged",     &whc_createpayload_issuancemanaged, {} },
    { "omni layer (payload creation)", "whc_createpayload_closecrowdsale",      &whc_createpayload_closecrowdsale, {} },
    { "omni layer (payload creation)", "whc_createpayload_destroyERC721token",      &whc_createpayload_destroyERC721token, {} },
    { "omni layer (payload creation)", "whc_createpayload_issueERC721property",      &whc_createpayload_issueERC721property, {} },
    { "omni layer (payload creation)", "whc_createpayload_transferERC721token",      &whc_createpayload_transferERC721token, {} },
    { "omni layer (payload creation)", "whc_createpayload_issueERC721token",      &whc_createpayload_issueERC721token, {} },
    { "omni layer (payload creation)", "whc_createpayload_burnbch",             &whc_createpayload_burnbch, {} },
    { "omni layer (payload creation)", "whc_createpayload_particrowdsale",             &whc_createpayload_particrowdsale, {} },
    { "omni layer (payload creation)", "whc_createpayload_freeze",              &whc_createpayload_freeze, {} },
